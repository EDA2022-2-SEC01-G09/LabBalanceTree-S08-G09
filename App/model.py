...
def addCrime(analyzer, crime):
    ...
    updateAreaIndex(analyzer["reporting_area"], crime)
...
def updateAreaIndex(map, crime):
    ...
    if entry is None:
        ...
        om.put(map, occurredarea, datentry)
    else:
...
def newAreaEntry(crime):
    ...
    entry = {"reported_areas": None, "lstcrimes": None}
...
def addAreaIndex(areaentry, crime):
    ...
    offenseIndex = areaentry["reported_areas"]
